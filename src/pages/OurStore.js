...
<Color/>
            ...
            <div className="form-check"> 
              ...
              <label classn="form-check-label" htmlfor='color-1' >S (2)</label>
              </div>
              <div className="form-check"> 
              <input className="form-check-input" type="checkbox" value='' id='color-1' />
              <label classn="form-check-label" htmlfor='color-2' >M (2)</label>
              </div>
            </div>
          </div>
            </div>
...
<span className="badge bg-light text-secondary rounded-3 py-2 px-3">Mobile Phone</span>
...
<span className="badge bg-light text-secondary rounded-3 py-2 px-3">Headphone</span>
          ...
          <div className="random-products d-flex mb-3">
            ...
            <div className="w-50">
<h5>Unique Watch bulk 10 pack multi colored</h5>
<ReactStars
    count={5}
    size={24}
    value={4}
          ...
          <div className="d-flex  justify-content-between align-items-center"> 
            <div className="d-flex  align-items-center gap-10">
              ...
              form-control form-select'>
                ...
                <option value="title-ascending">Alphabetically, A-Z title-ascending</option>
                <option value="title-descending">Alphabetically, Z-A title-ascending</option>
                <option value="price-ascending">Price, low to high</option>
                <option value="price-desscending">Price, high to low</option>
                <option value="price-ascending">Date, old to new</option>
                <option value="price-desscending">Date, new to old</option>
              </select>
            </div>
            <div className="d-flex align-items-center gap-10">
